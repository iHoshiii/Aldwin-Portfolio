            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed sm:absolute bottom-28 sm:bottom-20 left-4 right-4 sm:left-auto sm:right-0 w-auto sm:w-[350px] md:w-[400px] h-[500px] max-h-[70vh] bg-white border border-black/10 rounded-3xl shadow-2xl flex flex-col overflow-hidden"
                    >
                        {/* Header */}
